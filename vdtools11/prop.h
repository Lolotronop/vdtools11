...
#ifndef _TASKBARSCROLLFLAG
#error _TASKBARSCROLLFLAG not defined
#endif

#ifndef _WHITENUMBERFLAG
#error _WHITENUMBERFLAG not defined
#endif
...
#define TASKBARSCROLLFLAG TEXT(MACRO_EXPANSION_TO_STR(_TASKBARSCROLLFLAG))
#define WHITENUMBERFLAG TEXT(MACRO_EXPANSION_TO_STR(_WHITENUMBERFLAG))
